...
in
{
  config = lib.mkIf (osConfig.myModule.home.compositor == "hyprland") {
    home.packages = with pkgs; [
      ...
      qt6Packages.qt6ct # doesn't work like this: https://www.lorenzobettini.it/2024/08/better-kde-theming-and-styling-in-hyprland/
      kdePackages.breeze
    ...
    wayland.windowManager.hyprland =
      let
        hyprland-conf = import ./_hyprland.conf.nix {
          inherit
            pkgs
            lib
            config
