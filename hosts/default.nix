...

{
  ...
  x1carbon = import ./x1carbon/nixosConfiguration.nix { hasCredentials = true; } inputs;
  x1carbon-no-cred = import ./x1carbon/nixosConfiguration.nix { hasCredentials = false; } inputs;
}
